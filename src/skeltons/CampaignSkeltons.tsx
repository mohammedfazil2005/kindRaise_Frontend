...
export const EditCampaignSkeleton = () => {
  return (
    <div className="grid lg:grid-cols-3 gap-10 mt-10 animate-pulse">
      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        <div>
          <div className="h-4 w-32 bg-gray-200 dark:bg-gray-700 rounded mb-2"></div>
          <div className="h-28 w-full bg-gray-200 dark:bg-gray-700 rounded-xl"></div>
        </div>
        ...
        <div>
          ...
          <div className="h-32 border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-xl bg-gray-100 dark:bg-gray-800"></div>
        </div>
