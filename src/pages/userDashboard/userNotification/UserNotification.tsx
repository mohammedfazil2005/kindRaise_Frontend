...
import { fetchUserNotifications, markAllUserNotificationAsRead, markNotificationAsRead } from "../../../services/apis/Notifications";
...
const UserNotification = () => {
  ...
  const markAllRead = async() => {
    setLoader(true)
    try {
      await markAllUserNotificationAsRead()
      refetch()
    } catch (error) {
